...
class FirstRunWizard:
    ...
    def show(self):
        ...
        self._build_header()
        self._body = tk.Frame(self.top, bg="#FFFFFF", bd=1, relief=tk.SOLID)
        self._body.pack(fill=tk.BOTH, expand=True, padx=18, pady=(0, 12))
        self._nav = tk.Frame(self.top, bg="#F1F5FF")
    ...
    def _build_header(self):
        header = tk.Frame(self.top, bg="#F1F5FF")
    ...
    def _render_step1(self):
        ...
        tk.Label(row, text="目录路径:", bg="#FFFFFF", fg="#2C3E50",
    ...
    def _render_step2(self):
        ...
        cb = tk.Checkbutton(self._body, text="✅ 在工作目录里生成 mapping_template.txt 并默认加载它",
                            variable=self.load_sample_mapping, bg="#FFFFFF",
                            fg="#2C3E50", font=('Microsoft YaHei UI', 11, "bold"),
                            activebackground="#FFFFFF", activeforeground="#1A2142",
                            selectcolor="#EEF3FF", bd=0, pady=6)
    ...
    def _render_step3(self):
        ...
        tk.Label(row, text="预设:", bg="#FFFFFF", fg="#2C3E50",
        ...
        # 显示所选预设的参数摘要
        self._preset_summary = tk.Label(self._body, text="", bg="#FFFFFF", fg="#3B6EFF",
