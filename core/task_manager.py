...
class TaskManager:
    def __init__(self, app, controller: Any = None):
        ...
        # 当前是否有任务正在 worker 上运行（用于关闭拦截 / 取消按钮显隐）
        self._active = False
            ...
            while not self._stop_event.is_set():
                try:
                    ...
                    try:
                        ...
                        self._result_queue.put(('cancelled', None, None))
            ...
            while True:
                ...
                try:
                    if typ == 'success':
                        ...
                        self.app.after(0, self._safe_dispatch_cancelled)
                    else:
    ...
    def _safe_dispatch_cancelled(self):
